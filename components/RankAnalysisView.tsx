    ...
    <div className="bg-slate-800/50 border border-slate-700 rounded-lg overflow-hidden shadow-lg h-full flex flex-col">
        ...
        <div className="overflow-x-auto flex-1 custom-scrollbar">
            <table className="w-full text-sm text-left">
                ...
                <tbody>
                    {data.map((stat, idx) => (
                        <tr key={stat.eventId} className="border-b border-slate-700/50 hover:bg-slate-700/30 transition-colors">
        ...
        <div className="w-full py-4 animate-fadeIn">
            <div className="mb-6">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-4">
                    <div>
                        <h2 className="text-3xl font-bold text-white mb-2">排名分數排行榜 (High Score Hall of Fame)</h2>
