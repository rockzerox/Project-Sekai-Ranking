  ...
  if (wlRankings.length > 0) {
    ...
    for (const charIdStr in chapterMap) {
      ...
      wlUpsertData.push({
        ...
        top10: getS(list, 10),
        top50: getS(list, 50),
        top100: getS(list, 100),
        border_200: getS(list, 200),
        border_300: getS(list, 300),
        border_400: getS(list, 400),
        border_500: getS(list, 500),
        border_1000: getS(list, 1000),
        border_2000: getS(list, 2000),
        border_5000: getS(list, 5000),
        border_10000: getS(list, 10000),
        computed_at: new Date().toISOString()
      });
    }
